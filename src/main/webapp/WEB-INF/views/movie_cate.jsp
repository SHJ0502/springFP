				...
				<div class="col-lg-11">
					<div class="row">
						<div class="col-lg-1" style="width: 8%;">
							<img class="img-circle" src="/resources/img/MVprofile.png" style="width: 80px;  min-height: 80px; ">
						</div>
						<div class="col-lg-2">
							<h3>영화</h3>
						</div>
	...
	<div class="row">
		...
		<div class="w3-row" style="margin-left: 133px">
		  ...
		  <div id="Tokyo" class="w3-container list" style="display:none">
		    <h2>정보</h2>
		    <p>YouTube 게임 채널을 방문하여 오늘의 인기 스타, 추천 아티스트, 재생목록을 찾아보세요. 구독하면 음악계의 최신 소식을 확인할 수 있습니다.
...
$.getJSON("/mychannel/getAllVideoList4.hta", function(result) {
