...
@Alias("GoodListByUserNo")
public class GoodListByUserNo {
	
	private int userNo;
	private String videoEmotion;
	private int videoNo;
	private int cateNo;
	...
	public String getVideoEmotion() {
		return videoEmotion;
	}

	public void setVideoEmotion(String videoEmotion) {
